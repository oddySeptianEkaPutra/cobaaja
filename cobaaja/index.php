...
<body>
                        ...
                        <?php foreach ($employees as $employee) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-primary btn-flat btn-xs" data-toggle="modal" data-target="#delete_data" href="#delete_data?id_name=<?php echo $employee["id_name"]; ?>"><i class="fa fa-trash"></i></a>
                                    <a class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#edit_data" href="#edit_data?id_name=<?php echo $employee["id_name"]; ?>"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <!-- Update Data -->
    <div class="modal fade" id="edit_data" tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="" method="POST" id="modal-save">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" value="<?php echo $employee["name"]; ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="work">Work:</label>
                            <select name="work" id="work" class="form-control">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <form action="deleteData.php" method="POST" id="modal-delete">
                    <input name="id_name" type="hidden" value="<?php echo $employee["id_name"]; ?>">
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                <button name="delete" type="submit" class="btn btn-primary" form="modal-delete">Delete</button>
            </div>
            </div>
        </div>
    </div>
